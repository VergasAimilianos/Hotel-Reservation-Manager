package com.Emil.HotelManagement.controller;
...
public class RoomController {
    ...
    public ResponseEntity<Response> addNewRoom(
        ...
        if(photo == null || photo.isEmpty() || roomType == null || roomType.isBlank() || roomPrice==null){
            ...
            response.setMessage("Please fill all the fields(photo, roomType, roomPrice)");
    ...
    )
    {
        ...
        if(checkInDate == null || checkOutDate == null || roomType == null || roomType.isBlank()){
            Response response = new Response();
            response.setStatusCode(400);
            response.setMessage("Please fill all the fields(checkInDate, checkOutDate, roomType)");
            return ResponseEntity.status(400).body(response);
