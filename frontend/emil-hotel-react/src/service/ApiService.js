...
export default class ApiService {
  static BASE_URL = import.meta.env.REACT_APP_API_BASE_URL || "http://localhost:4040";
  ...
  /**ROOM */
  /* Adds a new room room to the database */
  ...
  /* Gets all available by dates rooms from the database with a given date and a room type */
  ...
  /* Gets all room types from thee database */
  ...
  /**BOOKING */
  /* Saves a new booking to the databse */
  ...
  /* Gets alll bokings from the database */
